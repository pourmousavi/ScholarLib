  ...
  getPopularModels() {
    return [
      ...
      },
      {
        ...
        ram: '8 GB',
        quality: 'good',
        description: 'Google Gemma 4, fast edge model with 128K context'
      },
      {
        id: 'gemma4:e4b',
        name: 'Gemma 4 E4B',
        ...
        ram: '12 GB',
        quality: 'good',
        description: 'Google Gemma 4, recommended for research'
      },
      {
        id: 'gemma4:26b',
        name: 'Gemma 4 26B',
        ...
        ram: '24 GB',
        quality: 'excellent',
        description: 'Google Gemma 4 MoE, 256K context, most capable'
      },
      {
        id: 'llama3.1:70b',
        name: 'Llama 3.1 70B',
