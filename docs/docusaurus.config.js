...
const config = {
  ...
  url: 'https://apourmousavi.github.io',
  baseUrl: '/scholarlib/docs/',

  organizationName: 'apourmousavi',
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://apourmousavi.github.io/scholarlib/',
            label: 'Back to App',
            position: 'right',
          },
          {
            href: 'https://github.com/apourmousavi/scholarlib',
            label: 'GitHub',
            position: 'right',
          },
        ],
